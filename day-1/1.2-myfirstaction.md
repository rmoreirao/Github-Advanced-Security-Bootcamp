...
> Before you start with this lab, please remove the branch protection rule, so you can commit to the main branch without a pull request to speed up the process :smirk:
